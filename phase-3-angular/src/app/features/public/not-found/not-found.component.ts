...
@Component({
  ...
  styles: [`
    ...
    .error-code { font-size: 8rem; font-weight: 800; background: linear-gradient(135deg, #1677FF 0%, #003EB3 100%); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text; line-height: 1; margin-bottom: 16px; }
    ...
    .btn-primary { background: linear-gradient(135deg, #1677FF 0%, #003EB3 100%); color: #fff; }
